...
const Hint = ({ text, show, className }: Props) => {
    return (
        <div
            className={`${className} ${show === false ? "opacity-0" : "opacity-100"} ${show ? "visible" : "invisible"} transition-opacity duration-200`}
        >
            <div className="relative bg-secondary rounded-md p-2 shadow-black/20 shadow-sm">
